...
// assertThat(users).extracting(Users::getname).containsExactlyInAnyOrder("John",
// "Jane");
// }
...
// List<CartItem> johnsItems =
// repository.findCartItemsByUserId(john.getuserid());
...
// Orders saved = repository.saveOrder(TestData.newOrder(user, new
// BigDecimal("1049.99"), "PLACED"));
...
// Users user = repository.saveUser(TestData.newJohn());
// Orders order = repository.saveOrder(TestData.newOrder(user, new
// BigDecimal("10.00"), "PLACED"));
// Product product = persistProduct("Apple", new BigDecimal("2.00"), 50);
...
// Users user = repository.saveUser(TestData.newJohn());
// Orders order = repository.saveOrder(TestData.newOrder(user, new
// BigDecimal("50.00"), "PLACED"));
// Product apple = persistProduct("Apple", new BigDecimal("2.00"), 50);
// Product milk = persistProduct("Milk", new BigDecimal("5.26"), 30);
// repository.saveOrderItem(TestData.newOrderItem(order, apple, 2, new
// BigDecimal("2.00")));
// repository.saveOrderItem(TestData.newOrderItem(order, milk, 6, new
// BigDecimal("5.26")));
...
// Users john = repository.saveUser(TestData.newJohn());
// Users jane = repository.saveUser(TestData.newJane());
// Orders johnOrder = repository.saveOrder(TestData.newOrder(john, new
// BigDecimal("10.00"), "PLACED"));
// Orders janeOrder = repository.saveOrder(TestData.newOrder(jane, new
// BigDecimal("20.00"), "PLACED"));
// Product apple = persistProduct("Apple", new BigDecimal("2.00"), 50);
// repository.saveOrderItem(TestData.newOrderItem(johnOrder, apple, 2, new
// BigDecimal("2.00")));
// repository.saveOrderItem(TestData.newOrderItem(janeOrder, apple, 10, new
// BigDecimal("2.00")));

// List<OrderItem> johnsItems =
// repository.findOrderItemsByUserId(john.getuserid());
...
// Users user = repository.saveUser(TestData.newJohn());
// Orders order = repository.saveOrder(TestData.newOrder(user, new
// BigDecimal("28.26"), "PLACED"));

// Payment saved = repository.savePayment(
// TestData.newPayment(order, "CREDIT_CARD", "SUCCESS", new
// BigDecimal("28.26")));
...
// List<Payment> johnsPayments =
// repository.findPaymentsByUserId(john.getuserid());
...
// repository.saveOrderItem(TestData.newOrderItem(order, apple, 2, new
// BigDecimal("2.00")));
// repository.saveOrderItem(TestData.newOrderItem(order, apple, 1, new
// BigDecimal("2.00")));
